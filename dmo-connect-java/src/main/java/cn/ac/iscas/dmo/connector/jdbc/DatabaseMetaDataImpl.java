    ...
    public String getDatabaseProductName() throws SQLException {
        ...
        if (Objects.nonNull(dbType)) {
            if (dbType.startsWith("mysql")) {
                ...
                result = "Oracle";
            } else if (dbType.startsWith("dameng")) {
                result = "DM DBMS";
            }
        }
        return result;
        ...
        try {
            ...
            if (valueMap != null) {
                ...
                if (metas != null) {
                    ...
                    map.put("tableName", tableNamePattern);
                    List<Map<String, Object>> maps = new ArrayList<>();
                    maps.add(map);
                    rs.setCacheData(maps);
                }
            }
        } catch (IOException e) {
    ...
    public ResultSet getColumns(String catalog, String schemaPattern, String tableNamePattern, String columnNamePattern) throws SQLException {
        ...
        try {
            ...
            if (valueMap != null) {
                List<Map<String, Object>> metas = (List<Map<String, Object>>) valueMap.get("metas");
                if (metas != null) {
                    Optional<Map<String, Object>> mapOptional = metas.stream().filter(map -> {
                        String name = (String) map.get("columnName");
                        if (Objects.equals(name, columnNamePattern)) {
                            return true;
                        }
                        return false;
                    }).findFirst();
                    if (mapOptional.isPresent()) {
                        ...
                        cacheData.add(mapOptional.get());
                        resultSet.setCacheData(cacheData);
                    }
                }
            }
        } catch (IOException e) {
            throw new SQLException("获取列元数据出错", e);
        }
        return resultSet;
    }

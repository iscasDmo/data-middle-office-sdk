...
public class OkHttpCustomClient {
    ...
    public Response doPostWithRes(String url, Map<String, String> headerMap, Map<String, Object> mapParams) throws IOException {
        Call call = basePostCall1(url, headerMap, mapParams);
        return call.execute();
    }
                ...
                if (data instanceof String) {
                    ...
                    RequestBody requestBody = new RequestBody() {
                        ...
                        public void writeTo(BufferedSink bufferedSink) throws IOException {
                            IoUtils.transferTo(is, bufferedSink.outputStream());
                        }
                    };
